...
# def open_follow_close_losscut_by_yesterday_close_with_limit(dataset, code, holding_days, limit_range,  α, params_x1=20, params_x2=20, params_x3=20, params_x4=60):#今回アルファは実際には不使用
...
#             #先に損益計算しとく
#             pl = md.calc_pl_with_open_losscut_by_yesterday_close_with_limit(dataset, index, holding_days, limit_range)
...
#     # print(dataset)
#     summary1 = open_follow_close_losscut_by_yesterday_close_with_limit(dataset, "sample", 1, 40, 100000)
