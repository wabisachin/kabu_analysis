...
def open_follow_close_losscut_by_yesterday_low(dataset, code, holding_days, α, params_x1=20, params_x2=20, params_x3=20, params_x4=60):#今回アルファは実際には不使用
    ...
    for index, data in dataset.iterrows():
        ...
        if(gap_rate > 0.02 or gap_rate < -0.02):
            ...
            #先に損益計算しとく
            pl = md.calc_pl_with_open_losscut_by_yesterday_highlow(dataset, index, holding_days)
...
if __name__ == "__main__":
    ...
    print(dataset)
    summary1 = open_follow_close_losscut_by_yesterday_low(dataset, "sample", 1, 100000)
    summary2 = open_follow_close_losscut_by_yesterday_low(dataset, "sample", 3, 100000)
