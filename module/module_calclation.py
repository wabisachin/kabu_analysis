...
def plot_biaxial_graph_for_EV(df, variable, name_dir, save=1):#widthは区間幅, rightは境界値。例えばx2の場合は各区間幅(width)は1,境界値は7が妥当。
    ...
    label_list ={
        ...
        "x8": {"bin_labels":["-10％以上", "-10％~-7.5％","-7.5％~-5.0％","-5.0％~-2.5％","-2.5％~0％", "0％~2.5％", "2.5％~5.0％","5.0％~7.5％","7.5％~10.0％","10.0％以上" ], "bins":[-1,-0.1, -0.075, -0.05, -0.025, 0, 0.025, 0.05, 0.075, 0.1, 1]},
        ...
        "x11": {"bin_labels":["-10％以上", "-10％~-7.5％","-7.5％~-5.0％","-5.0％~-2.5％","-2.5％~0％", "0％~2.5％", "2.5％~5.0％","5.0％~7.5％","7.5％~10.0％","10.0％以上" ], "bins":[-1,-0.1, -0.075, -0.05, -0.025, 0, 0.025, 0.05, 0.075, 0.1, 1]},
